...
export const RETURNING_USERS_REQUEST = "RETURNING_USERS_REQUEST" ;
export const RETURNING_USERS_SUCCESS = "RETURNING_USERS_SUCCESS" ;
export const RETURNING_USERS_FAIL =    "RETURNING_USERS_FAIL" ;
...
export const RESEND_PHONE_OTP_FAIL =    "RESEND_PHONE_OTP_FAIL" ;
